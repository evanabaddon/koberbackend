<?php namespace App\Http\Controllers;
	...
	class AdminCtaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Tombol","name"=>"tombol"];
			...
			$this->form[] = ['label'=>'Tombol','name'=>'tombol','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Tombol","name"=>"tombol","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
